...
# Django | Order Model, Order Item Model in order application 2/12
...
class OrderItem(models.Model):
    ...
    def __str__(self):
        return self.name
# Django | Order Model, Order Item Model in order application 2/12 __END
# Django | Order Model, Order Item Model in order application 3/12 in admin.py
    #NOTE: Don't forget two Command for migration
